...
const Product = () => {
  ...
  const dataForSteps = [
    ...
    },
    {
      ...
      img: `${dirRoot}quality-check-min.png`,
    },
    {
    ...
    },
    {
      ...
      img: `${dirRoot}robust-returns-min.png`,
    },
  ];
    ...
    <div id="product" title="product">
      ...
      <SectionImgContentGrid
        data={{
          ...
          img: "/assets/pages/product/hero-min.png",
        }}
      />

      <div className="mini-quotes">
        <p data-animname="fade-in-up" data-onetime="true" data-delay="0">
      ...
      <section className="steps">
        <h2
          ...
          data-onetime="true"
          data-delay="0"
          className="heading main-heading primary-font"
        >
      ...
      <div className="basic-grid-container page-width">
        ...
        <div className="img-container">
          <ResponsiveDisplayImg
            data={{
              img: "/assets/pages/product/logos-combined-min.png",
            }}
          />
        </div>
      </div>
      ...
      {/* <SectionImgContentGrid
        data={{
          ...
          img: "/assets/pages/product/inventory-min.png",
          imgRight: false,
        }}
      /> */}
      ...
      {/* <SectionImgContentGrid
        data={{
          ...
          img: "/assets/pages/product/inventory-dashboard-min.png",
          mobImg: "/assets/pages/product/inventory-dashboard-mob-min.png",
          imgRight: true,
        }}
      /> */}
      ...
      {/* <SectionImgContentGrid
        data={{
          ...
          img: "/assets/pages/product/report-min.png",
          mobImg: "/assets/pages/product/report-mob-min.png",
          imgRight: false,
        }}
      /> */}
      ...
      {/* <SectionImgContentGrid
        data={{
          ...
          img: "/assets/pages/product/dispatch-min.png",
          imgRight: true,
        }}
      /> */}
      ...
      {/* <SectionImgContentGrid
        data={{
          ...
          img: "/assets/pages/product/returns-min.png",
          mobImg: "/assets/pages/product/returns-mob-min.png",
          imgRight: false,
        }}
      /> */}
      ...
      <SectionImgContentGrid
        data={{
          ...
          img: "/assets/pages/product/download-min.png",
          urlTo: "/guide",
          urlText: "Download",
          imgRight: true,
        }}
